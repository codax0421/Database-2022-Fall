...
const Home = () => {
  ...
  return(
    <>
 <>
    <Select  mode="multiple" style={{width: '10%',marginTop:"20px",marginLeft:"30px",}} options={category.map((item) => ({
        value: item.name,
        label: item.name,
      }))}/>
      <Select  mode="multiple" style={{width: '10%',marginTop:"20px",marginLeft:"30px",}} options={tag.map((item) => ({
        value: item.name,
        label: item.name,
      }))}/>
